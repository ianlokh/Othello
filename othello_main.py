...
class Othello():
    ...
    # playerposlist[i+1]
    def generate_player_pos_list(self, _gridpos):
    ...
    def init_board(self, _poslist):
        ...
        self.game_board[3, 3] = black_player[0]
        self.game_board[4, 4] = black_player[0]
        self.game_board[3, 4] = white_player[0]
        self.game_board[4, 3] = white_player[0]

        self.draw_token(3, 3, black_player[1], _poslist)
        self.draw_token(4, 4, black_player[1], _poslist)
        self.draw_token(3, 4, white_player[1], _poslist)
        self.draw_token(4, 3, white_player[1], _poslist)
        ...
        self.instruction.write(black_player[2] + " To Play", align="center", font=("Courier", 24, "bold"))
    ...
    def calculate_score(self, _game_board):
    ...
    def add_to_board(self, x_ind, y_ind, player):
        ...
        self.game_board[x_ind, y_ind] = player[0]

        # draw the player's token on the screen
        self.draw_token(x_ind, y_ind, player[1], self.playerposlist)
        ...
        def eval_cell(x, y, _direction, _player, _flip_seq, _flip_tokens):
            try:
                ...
                if player[0] != cell_value:
                    ...
                    _flip_tokens = False
                elif player[0] == cell_value:  # if the cell is the player's token then end the recursion
                    _flip_tokens = True
                    return _flip_tokens, _flip_seq
        ...
        for direction in range(8):
            ...
            if flip_tokens and len(flip_seq) > 0:
                ...
                for i in range(len(flip_seq)):
                    self.game_board[flip_seq[i][0], flip_seq[i][1]] = player[0]
                    self.draw_token(flip_seq[i][0], flip_seq[i][1], player[1], self.playerposlist)
    ...
    def play_token(self, _x_pos, _y_pos):
        ...
        self.score.write(white_player[2] + " score:" + str(_score_white), align="center", font=("Courier", 24, "bold"))

        self.score.penup()
        self.score.goto(0, -(self.window.window_height() / 2) + 670)
        self.score.write(black_player[2] + " score:" + str(_score_black), align="center", font=("Courier", 24, "bold"))
        ...
        self.instruction.hideturtle()
        self.instruction.goto(0, -(self.window.window_height() / 2) + 100)
        self.instruction.write(next_player[2] + " To Play", align="center", font=("Courier", 24, "bold"))
